...
- **Use `ProofSummaryBuilder` for the JSON summary**: Import from `scripts.proof_summary` — it builds v3 format with `format_version: "1.21.3"
...
#   Primary path for building proof.json. Produces format_version: "1.21.3"
